                ...
                <div class="col-sm-12">
                    <div class="main_contact sections">
                        <div class="head_title text-center whitetext">
                            <h2 style="color: white; font-size: 30px"><br>Pre-processed Tweets</h2>
                        ...
                        <div >
                            ...
                            <center><table id="customers">
                                    ...
                                    <%
                                        ...
                                        while (rs.next()) {
                                            System.out.println("After Preprocessed " + rs.getString("idd"));
                                            System.out.println("After Preprocessed " + rs.getString("imageurl"));
                                            System.out.println("After Preprocessed " + rs.getString("name"));
                                            System.out.println("After Preprocessed " + rs.getString("tweet"));
//                                            System.out.println("After Preprocessed " + rs.getString("retweet"));
                                ...
                                <!--                                <form action="ppcode.jsp">
                                                                    <button style="width: 25%;
                                                                            ...
                                                                            border: none;
                                                                            border-radius: 4px;
                                                                            cursor: pointer;">Pre Processing</button>
                                                                </form>-->
                            </center>
