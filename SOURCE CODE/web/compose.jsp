            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="main_contact sections">
                        ...
                        <center><h2  style="color: white; font-size: 32px"><br>COMPOSE TWEET'S</h2></center>
                        <div class="row">
                            <div class="contact_contant">
                                <div class="col-sm-6 col-xs-12">
                                    <!--<div class="single_message_right_info whitetext">-->
                                    <ul>
                                        <br><br><img width="400" height="350" src="images/logo.png">
                                    </ul>
                                </div>
                            </div><!-- End of col-sm-6 -->
                            <style>
                                ...
                                <div class="single_contant_left margin-top-60">
                                    ...
                                    <div>
                                        <form  action="Twitter" method="post" enctype="multipart/form-data">
                                            <table>
                                                <tr>
                                                    <td><label for="fname">Message : </label></td>
                                                    <td><textarea name="msg" required=""  style="width: 250px; height: 150px"></textarea></td>
                                                </tr>
                                                
                                                <tr>
                                                    <td><label for="file">Attachment : </label></td>
                                                    <td><input type="file" style="width: 250px" id="fname" name="photo" ></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td><input style="width: 250px" type="submit" value="Tweet"> </td>
                                                </tr>
