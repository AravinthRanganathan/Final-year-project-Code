                ...
                <div class="col-sm-12">
                    <div class="main_contact sections">
                        <div class="head_title text-center whitetext">
                            <h2 style="color: white; font-size: 32px"><br>ADMIN LOGIN</h2>
                        ...
                        <div class="row">
                            <div class="contact_contant">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <ul>
                                        <br><img width="400" height="300" src="images/register1.jpg">
                                    </ul>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="single_contant_left margin-top-60">
                                    ...
                                    <div><br>
                                        <form action="admin_log.jsp" method="get">
                                             <table>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="password" style="width: 240px" id="fname" name="pass" placeholder="Password.."></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
